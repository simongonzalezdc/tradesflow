    ...
    <main className="min-h-[100dvh] bg-[#f7f4ee] text-slate-950">
      ...
      <section className="px-5 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.55fr_1fr]">
          <aside>
            <p className="text-xs font-bold uppercase tracking-[0.22em] text-amber-700">Trust center</p>
            ...
            <div className="mt-8 rounded-lg bg-white p-5 text-sm leading-6 text-slate-600 ring-1 ring-slate-200">
              TradesFlow is designed for Canadian field-service businesses that need clear expectations around customer records, account data, and essential service cookies.
            </div>
          </aside>
          <article className="rounded-lg bg-white p-6 shadow-[0_24px_70px_-60px_rgba(15,23,42,0.55)] ring-1 ring-slate-200 sm:p-8">
            <div className="space-y-8 text-sm leading-7 text-slate-700 [&_a]:font-semibold [&_a]:text-blue-700 [&_a:hover]:text-blue-900 [&_h2]:text-xl [&_h2]:font-black [&_h2]:tracking-[-0.02em] [&_h2]:text-slate-950 [&_li]:pl-1 [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5">
              {children}
            </div>
          </article>
        </div>
