        ...
        <section className="flex flex-col justify-between border-b border-slate-200 bg-white p-6 sm:p-8 lg:border-b-0 lg:border-r">
          <div>
            ...
            <div className="mt-12 max-w-md">
              <p className="text-xs font-bold uppercase tracking-normal text-amber-700">Account access</p>
              <h1 className="mt-4 text-3xl font-black tracking-normal text-slate-950 sm:text-4xl">{title}</h1>
          ...
          <div className="mt-10 grid gap-3 text-sm text-slate-600 sm:grid-cols-3 lg:grid-cols-1">
            ...
            <p className="rounded-lg bg-slate-50 p-3 ring-1 ring-slate-200">Consent and data-rights foundation for prototype validation.</p>
          </div>
        </section>
        ...
        <section className="flex flex-col justify-center bg-slate-950 p-6 text-white sm:p-8">
          <div className="mx-auto w-full max-w-md">
            <div className="mb-8 rounded-lg bg-white/6 p-5 ring-1 ring-white/10">
              <p className="text-xs font-bold uppercase tracking-normal text-amber-300">{panelTitle}</p>
